        ...
        try {
            ...
            try {
                ...
                addAnnotation("# ================================================================================================")
                        ...
                        .addAnnotation("# ")
                        .addAnnotation("#  >> speedLimit")
                        .addAnnotation("# ")
                        .addAnnotation("#      Limit user's upload & download speed. There is no limit")
                        .addAnnotation("#      format: speedLimit=[username];[upload(kb/s)];[download(kb/s)]; ...")
                        .addAnnotation("# ")
                        .addAnnotation("#      限制用户的上传和下载速度。数值为0或不填时不限制。")
                        .addAnnotation("#      格式：speedList=[用户名];[上传速度(kb/秒)];[下载速度(kb/秒)]; ...")
                        .addAnnotation("# ")
                        .addAnnotation("# ================================================================================================")
                ...
                addProperty("user", "anonymous;;r;/;/;admin;123456;r;/;/root;")
                        ...
                        .addProperty("speedLimit", "anonymous;0;10240;admin;;20480;")
